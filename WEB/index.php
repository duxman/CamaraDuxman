<?php
	...
	*/	
	...
	define('GALLERY_ROOT', './galeria/');
	define('DATA_ROOT', './thumbs/');
	define('SECURITY_PHRASE', 'L0M103SM10');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
	...
	$dir_exclude = array('thumbs', '_sfpg_icons');
	...
	define('TEXT_GALLERY_NAME', 'My First Galllery');
	define('TEXT_BANNER', 'Welcome');
	define('TEXT_HOME', 'Inicio');
	define('TEXT_CLOSE_IMG_VIEW', 'Cerrar Imagen');
	define('TEXT_ACTUAL_SIZE', 'Tamaño Actual');
	define('TEXT_FULLRES', 'Full resolution');
	define('TEXT_PREVIOUS', '<< Anterior');
	define('TEXT_NEXT', 'Siguiente >>');
	define('TEXT_INFO', 'Informacion');
	define('TEXT_DOWNLOAD', 'Download');
	define('TEXT_SLIDESHOW', 'Slideshow');
	define('TEXT_NO_IMAGES', 'Album Vacia');
	define('TEXT_DATE', 'Fecha');
	define('TEXT_FILESIZE', 'Tamaño');
	define('TEXT_IMAGESIZE', 'Imagen Completa');
	define('TEXT_DISPLAYED_IMAGE', 'Imagen mostrada');
	define('TEXT_DIR_NAME', 'Nombre del Album');
	define('TEXT_IMAGE_NAME', 'Nombre de la imagen');
	define('TEXT_FILE_NAME', 'Nombre del fichero');
	define('TEXT_DIRS', 'Directorios');
	define('TEXT_IMAGES', 'Imagenes');
	define('TEXT_IMAGE_NUMBER', 'Numero');
	define('TEXT_FILES', 'Ficheros');
	define('TEXT_DESCRIPTION', 'Descripcion');
	define('TEXT_DIRECT_LINK_GALLERY', 'Acceso directo a el album');
	define('TEXT_DIRECT_LINK_IMAGE', 'Acceso direto a la imagen');
	define('TEXT_NO_PREVIEW_FILE', 'Sin imagen');
	define('TEXT_IMAGE_LOADING', 'Imagen cargandose ');
	define('TEXT_LINKS', 'Links');
	define('TEXT_NOT_SCALED', 'Sin sscala');
	define('TEXT_LINK_BACK', 'Volver al mi sitio');
	define('TEXT_THIS_IS_FULL', 'Full');
	define('TEXT_THIS_IS_PREVIEW', 'Preview');
	define('TEXT_SCALED_TO', 'redimensionar a ');
	define('TEXT_YES', 'Si');
	define('TEXT_NO', 'No');
	define('TEXT_FIRST_VIEW', 'Esta es la primera vez que se ve la foto, refresca para ver la información');
	...
	define('TEXT_MKDIR', 'Crear directorio');
	define('TEXT_UPLOAD', 'Subir');
	define('TEXT_NOTHING', 'Nada Seleccionado');
	define('TEXT_ONLY_ONE', 'Selecciona un unico elemento');
	define('TEXT_ONE_IMAGE', 'Selecciona un unico elemento');
	...
	define('TEXT_EXIF_MISSING', 'sin información EXIF');
